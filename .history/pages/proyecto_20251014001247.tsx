...
import { proyectosData, proyectoDestacado, Proyecto } from "../data/proyectosData";
...
const ProyectoIndividual: React.FC = () => {
  ...
  const getBackButtonInfo = () => {
    // Si viene de la página de proyectos (/proyectos)
    if (router.query.from === 'proyectos') {
      return {
        text: 'Volver a Proyectos',
        action: () => router.push('/proyectos')
      };
    }
    // Si viene de la página principal o cualquier otra página
    return {
  ...
  // Buscar el proyecto por ID (incluye proyecto destacado)
  const proyecto = [...proyectosData, proyectoDestacado].find(p => p.id === parseInt(id as string));
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl lg:text-5xl text-gray-900 mb-4 font-light overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-6">
                <a 
                  href="#" 
                  className="group relative p-3 rounded-full bg-gray-800/50 hover:bg-gray-700 transition-all duration-300 hover:scale-110 hover:shadow-lg"
