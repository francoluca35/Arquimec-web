            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                <motion.button
                  ...
                  className="bg-gradient-to-r from-amber-500 to-yellow-600 text-white px-8 py-4 rounded-xl font-medium text-lg shadow-lg z-50 hover:shadow-xl transition-all duration-300 self-start"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
