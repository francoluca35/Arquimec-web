            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 pt-8 border-t border-gray-200">
                <div>
                  ...
                  <p className="text-xl text-gray-900 font-light">{proyecto.area}</p>
                </div>
                <div>
                  <span className="text-sm text-gray-500 uppercase tracking-wider">Ubicación</span>
                  <p className="text-xl text-gray-900 font-light">{proyecto.ubicacion}</p>
                </div>
              </div>
            </motion.div>
          </div>
