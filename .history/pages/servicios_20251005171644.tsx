  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        {/* CTA Section */}
        <motion.section 
          className="py-20 bg-[#0F1516] text-white"
          initial={{ opacity: 0 }}
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <button
                ...
                className="border-2 solid 2px border-white text-white px-8 py-4 text-lg font-medium hover:bg-white hover:text-gray-900 transition-colors duration-300"
              >
                Ver Proyectos
              </button>
            </div>
        ...
        {/* Footer */}
        <motion.footer 
          className="bg-[#0F1516] text-white py-16"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
