    ...
    <>
      ...
      <div className="showcase-container">
        ...
        <div className="showcase-info">
          ...
          <div className="info-card">
            <h3>Versión Realista</h3>
            <ul>
              <li>Basada en el diseño original SVG</li>
              <li>Colores dorados auténticos</li>
              <li>Formas geométricas precisas</li>
              <li>Fiel al logo de ARQUIMEC</li>
            </ul>
          </div>
        </div>
      </div>
