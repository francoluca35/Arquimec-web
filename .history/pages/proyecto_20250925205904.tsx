          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-6">
                ...
                <a 
                  href="#" 
                  className="group relative p-3 rounded-full bg-gray-800/50 hover:bg-gradient-to-r hover:from-red-500 hover:to-red-500 transition-all duration-300 hover:scale-110 hover:shadow-lg"
                  aria-label="YouTube"
                >
                  <svg className="w-6 h-6 text-gray-400 group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
