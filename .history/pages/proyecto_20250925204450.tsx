            ...
            <div className="fixed inset-0 z-50 bg-black/95 flex items-center justify-center p-8">
              <div className="relative max-w-5xl w-full h-full flex flex-col items-center justify-center">
                <button
                  ...
                  className="absolute top-8 right-8 z-10 bg-white/20 hover:bg-white/30 rounded-full p-3 text-white transition-colors"
                >
                  <X className="w-6 h-6" />
                </button>
                  ...
                  {proyecto.galeriaVistas[categoriaActual].imagenes.length > 1 && (
                    <>
                      <button
                        ...
                        className="absolute left-6 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white rounded-full p-4 shadow-xl transition-all hover:scale-110"
                      >
                        <ChevronLeft className="w-6 h-6 text-gray-700" />
                      </button>
                      <button
                        onClick={siguienteImagen}
                        className="absolute right-6 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white rounded-full p-4 shadow-xl transition-all hover:scale-110"
                      >
