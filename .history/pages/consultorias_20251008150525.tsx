  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white overflow-x-hidden w-full">
        ...
        <motion.section
          id="main-content"
          className="relative h-screen bg-gray-900 flex items-center justify-center overflow-hidden pt-20 w-full"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        {/* Sección Manifiesto */}
        <motion.section
          className="py-20 bg-gray-50 relative w-full overflow-hidden"
          initial={{ opacity: 0 }}
        ...
        {/* Footer */}
        <motion.footer
          className="bg-gray-900 text-white py-16 w-full overflow-hidden"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
