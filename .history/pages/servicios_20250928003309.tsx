...
const Servicios: React.FC = () => {
  ...
  const handleServiceClick = (servicio: any) => {
    if (servicio.titulo === "Diseño de Interiores") {
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-8">
                ...
                <div className="flex items-center space-x-6">
                  <button
                    onClick={() => router.push('/arquitectura-residencial')}
                    className="text-gray-600 hover:text-gray-900 transition-colors font-medium"
                  >
                    Arq Residencial
                  </button>
                  <button
                    onClick={() => router.push('/arquitectura-comercial')}
                    className="text-gray-600 hover:text-gray-900 transition-colors font-medium"
                  >
                    Arq Comercial
                  </button>
                  <button
                    onClick={() => router.push('/diseno-interiores')}
                    className="text-gray-600 hover:text-gray-900 transition-colors font-medium"
                  >
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <button
                ...
                className="border border-white text-white px-8 py-4 text-lg font-medium hover:bg-white hover:text-gray-900 transition-colors duration-300"
              >
                Ver Proyectos
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
              ...
              <div>
                ...
                <ul className="space-y-3 text-gray-300">
                  ...
                  <li><button onClick={() => router.push('/#contacto')} className="hover:text-white transition-colors">Consultorías</button></li>
                </ul>
              </div>
