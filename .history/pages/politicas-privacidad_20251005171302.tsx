...
const PoliticasPrivacidad: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <header className="py-8 px-6 lg:px-8 bg-[#0F1516]">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <h1 className="text-2xl font-light text-white">ARQUIMEC.</h1>
        </div>
      </header>

      {/* Contenido principal */}
      <main className="max-w-4xl mt-10 mx-auto px-6 lg:px-8 py-16">
        <motion.div
        ...
        >
          ...
          >
            <button
              onClick={() => router.push('/')}
              className="bg-[#0F1516] text-white px-8 py-4 text-lg tracking-wider hover:bg-gray-800 transition-all duration-300 hover:scale-105"
            >
              Volver al Sitio
            </button>
          </motion.div>
