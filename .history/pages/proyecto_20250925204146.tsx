...
const ProyectoIndividual: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header Fijo */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200 py-4 px-6 lg:px-8">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="relative group">
            <div 
              className="aspect-video bg-gray-100 rounded-2xl overflow-hidden shadow-2xl bg-cover bg-center bg-no-repeat"
              style={{
