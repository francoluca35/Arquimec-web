                  ...
                  {proyecto.galeriaVistas[categoriaActual].imagenes.length > 1 && (
                    <>
                      <button
                        ...
                        className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white rounded-full p-3 shadow-xl transition-all hover:scale-110"
                      >
                        <ChevronLeft className="w-5 h-5 text-gray-700" />
                      </button>
                      <button
                        onClick={siguienteImagen}
                        className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white rounded-full p-3 shadow-xl transition-all hover:scale-110"
                      >
                  ...
                  {proyecto.galeriaVistas[categoriaActual].imagenes.map((imagen, index) => (
                    <button
                      ...
                      className={`w-16 h-16 rounded-lg overflow-hidden border-2 transition-all hover:scale-105 ${
                        index === imagenActual ? 'border-white shadow-lg' : 'border-white/50 hover:border-white/80'
                      }`}
                    >
                      <div 
                        className="w-full h-full bg-cover bg-center bg-no-repeat"
