...
export const proyectosData: Proyecto[] = [
  ...
  },
  {
    ...
    categoria: "PROYECTO RESIDENCIAL",
    ubicacion: "LUJAN, Argentina",
    año: "2023",
    imagenHero: "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415617/lujan/principal.jpg",
    ...
    galeriaVistas: [
      {
        ...
        imagenes: [
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415617/lujan/principal.jpg"
        ]
      },
      {
        titulo: "Interiores",
        imagenes: [
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415618/lujan/corte3.jpg",
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415620/lujan/int12.jpg",
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415622/lujan/I11.jpg",
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415624/lujan/I10.jpg",
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415625/lujan/I9.jpg"
        ]
      },
      {
        titulo: "Detalles Arquitectónicos",
        imagenes: [
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415627/lujan/I8.jpg",
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415628/lujan/I1.jpg",
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415630/lujan/i4.jpg",
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415631/lujan/FON4.jpg"
        ]
      }
    ],
    caracteristicas: [
  ...
  },
  {
    ...
    año: "2024",
    imagenHero: "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415275/lanus/principal.jpg",
    descripcion: "Proyecto residencial ubicado en Lanús que combina funcionalidad y diseño contemporáneo. Esta vivienda representa la perfecta integración entre espacios interiores y exteriores, creando un ambiente acogedor y moderno para sus habitantes.",
    conceptoArquitectonico: "El concepto arquitectónico se centra en la optimización del espacio y la maximización de la luz natural. Utilizamos materiales locales y técnicas constructivas eficientes para crear una vivienda sustentable que se adapta perfectamente al entorno urbano de Lanús.",
    galeriaVistas: [
      {
        titulo: "Vista Principal",
        imagenes: [
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415275/lanus/principal.jpg"
        ]
      },
      {
        titulo: "Procesos de Construcción",
        imagenes: [
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415276/lanus/proceso05.jpg",
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415277/lanus/proceso06.jpg",
          "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760415278/lanus/proceso08.jpg"
        ]
      }
    ],
    caracteristicas: [
      {
        titulo: "Superficie Total",
        valor: "180 m²",
        descripcion: "Distribución optimizada de espacios",
        icono: "🏠"
      },
      {
        titulo: "Superficie Cubierta",
        valor: "150 m²",
        descripcion: "Espacios interiores funcionales",
        icono: "📏"
      },
      {
        titulo: "Dormitorios",
        valor: "3",
        descripcion: "Incluye dormitorio principal",
        icono: "👥"
      },
      {
        titulo: "Cochera",
        valor: "1",
        descripcion: "Cubierta con portón automático",
        icono: "🚗"
      },
      {
        titulo: "Patio",
        valor: "30 m²",
        descripcion: "Espacio exterior privado",
        icono: "🌳"
      },
      {
        titulo: "Eficiencia Energética",
