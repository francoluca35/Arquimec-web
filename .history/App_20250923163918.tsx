      ...
      >
        <div className="w-full px-2 lg:px-2">
          <div className="flex justify-between items-center py-4 lg:py-6">
            ...
            >
              <span
                className="text-2xl lg:text-3xl tracking-wider text-white"
                style={{
                  fontWeight: 300,
                  letterSpacing: "0.1em",
                }}
            ...
            <div className="hidden lg:flex items-center space-x-1">
              <nav className="flex gap-4 items-center space-x-2">
                {[
                  ...
                  <motion.a
                    key={item.name}
                    href={item.href}
                    className="text-white hover:text-gray-300 transition-colors text-sm tracking-wider"
                    style={{
                      fontWeight: 400,
                      letterSpacing: "0.1em",
                    }}
              ...
              >
                <Button
                  variant="outline"
                  className="border gap-2 border-white text-white hover:bg-white hover:text-black px-4 py-2 rounded-full text-sm tracking-wider transition-all duration-300"
                  style={{
                    fontWeight: 400,
                    letterSpacing: "0.1em",
                  }}
              ...
              <div className="flex flex-col space-y-4">
                {[
                  ...
                  <a
                    key={item.name}
                    href={item.href}
                    className="text-white hover:text-gray-300 transition-colors py-2 text-sm tracking-wider"
                    style={{
                      fontWeight: 400,
                      letterSpacing: "0.1em",
                    }}
                ...
                <Button
                  variant="outline"
                  className="border border-white text-white hover:bg-white hover:text-black w-full mt-4 rounded-full text-sm tracking-wider"
                  style={{
                    fontWeight: 400,
                    letterSpacing: "0.1em",
                  }}
