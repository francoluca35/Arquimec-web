          ...
          <div className="flex justify-between items-center py-4 lg:py-6">
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              >
                <Button
                  variant="outline"
                  className="border -mr-30 border-white text-white hover:bg-white hover:text-black px-6 py-2 rounded-full text-sm tracking-wider transition-all duration-300"
                  style={{
                    fontWeight: 400,
                    letterSpacing: "0.1em",
                  }}
