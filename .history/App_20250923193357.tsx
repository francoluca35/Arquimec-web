...
const AnimatedLogo: React.FC<AnimatedLogoProps> = ({ className = '', onAnimationComplete, scrolled = false }) => {
  return (
    <div className={`flex items-center ml-10 ${className}`}>
      {/* Logo simple y visible */}
      <div className="flex items-center space-x-3">
        {/* Círculo con letra A */}
        <div className="w-12 h-12 rounded-full border-2 border-white bg-[#1a2a3c] flex items-center justify-center">
