          ...
          <div className="flex justify-between items-center py-4 lg:py-6">
            ...
            <div className="hidden lg:flex items-center space-x-6 pr-4">
              ...
              >
                <Button
                  variant="outline"
                  className={`border-2 px-6 py-3 text-sm tracking-wider transition-all duration-500 transform hover:scale-105 hover:-translate-y-1 ${
                    scrolled
                      ? "border-black text-black bg-transparent hover:bg-transparent hover:text-black"
                      : "border-white text-white bg-transparent hover:bg-transparent hover:text-white"
                  }`}
                  style={{
                    fontWeight: 400,
                    letterSpacing: "0.1em",
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="flex flex-col space-y-4">
                ...
                <Button
                  variant="outline"
                  className={`border-2 w-full mt-4 text-sm tracking-wider transition-all duration-500 transform hover:scale-105 hover:-translate-y-1 ${
                    scrolled
                      ? "border-black text-black bg-transparent hover:bg-tramsparent hover:text-black"
                      : "border-white text-white hover:bg-transparent hover:text-white"
                  }`}
                  style={{
                    fontWeight: 400,
                    letterSpacing: "0.1em",
