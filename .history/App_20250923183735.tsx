  ...
  return (
    <div className={`relative w-12 h-12 ${className}`}>
      ...
      <div className={`absolute inset-0 flex items-center justify-center transition-all duration-1000 ${
        ...
        animationPhase === 'text' ? 'opacity-0 scale-0' :
          ...
          {particles.map((particle, index) => (
            <div
              ...
              style={{
                ...
                transform: `translate(${particle.vx * 15}px, ${particle.vy * 15}px) scale(${1 - index * 0.02})`,
      ...
      {animationPhase === 'reforming' && (
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          <div className="w-12 h-12 border-2 border-yellow-400 rounded-full animate-spin opacity-60"></div>
          <div className="absolute w-8 h-8 border border-yellow-300 rounded-full animate-spin opacity-70" style={{animationDirection: 'reverse', animationDuration: '0.8s'}}></div>
          ...
          <div className="absolute inset-0">
            {particles.slice(0, 10).map((particle, index) => (
              <div
                ...
                style={{
                  left: (particle.x + particle.vx * 15) + 'px',
                  top: (particle.y + particle.vy * 15) + 'px',
                  width: particle.size + 'px',
                  height: particle.size + 'px',
                  backgroundColor: particle.color,
                  transform: `translate(${-particle.vx * 15}px, ${-particle.vy * 15}px)`,
      ...
      <div className={`absolute inset-0 flex items-center justify-center transition-all duration-1000 ${
        ...
        <span className="text-xs font-bold text-yellow-400 drop-shadow-lg animate-pulse">
          ARQUIMEC
        </span>
      </div>
    </div>
      ...
      >
        <div className="w-full px-2 lg:px-2">
          <div className="flex justify-between items-center py-4 lg:py-6">
            ...
            >
              <AnimatedLogo className="h-8 lg:h-10 w-auto" />
            </motion.div>
