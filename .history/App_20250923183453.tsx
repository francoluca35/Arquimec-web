...
const AnimatedLogo: React.FC<AnimatedLogoProps> = ({ className = '', onAnimationComplete }) => {
  const [animationPhase, setAnimationPhase] = useState<'forming' | 'formed' | 'disassembling' | 'reforming' | 'text'>('forming');
    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20">
          <AnimatedLogo className="drop-shadow-2xl" />
        </div>
