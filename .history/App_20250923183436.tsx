    ...
    <div className={`relative w-80 h-80 mx-auto ${className}`}>
      ...
      {animationPhase === 'reforming' && (
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-64 h-64 border-4 border-yellow-400 rounded-full animate-spin opacity-50"></div>
          <div className="absolute w-48 h-48 border-2 border-yellow-300 rounded-full animate-spin opacity-75" style={{animationDirection: 'reverse'}}></div>
        </div>
      )}
