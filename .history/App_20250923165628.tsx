            ...
            <div className="hidden lg:flex items-center space-x-6 pr-4">
              ...
              >
                <div className="relative">
                  ...
                  <div 
                    className={`absolute button-20 inset-0 border-2 transition-all duration-500 ${
                      scrolled 
                        ? "border-black" 
                        : "border-white"
                    }`}
            ...
            >
              <div className="flex flex-col space-y-4">
                ...
                <div className="relative w-full mt-4">
                  ...
                  <Button
                    variant="outline"
                    className={`relative z-10 w-full text-sm tracking-wider transition-all duration-500 transform hover:scale-105 hover:-translate-y-1 ${
                      scrolled
                        ? "text-black hover:bg-black hover:text-white"
                        : "text-white hover:bg-white hover:text-black"
                    }`}
