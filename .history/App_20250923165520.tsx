            ...
            <div className="hidden lg:flex items-center space-x-6 pr-4">
              ...
              >
                <div className="relative">
                  ...
                  <Button
                    variant="outline"
                    className={`relative z-10 px-6 py-3 text-sm tracking-wider transition-all duration-500 transform hover:scale-105 hover:-translate-y-1 ${
                      scrolled
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="flex flex-col space-y-4">
                ...
                <Button
                  variant="outline"
                  className={`border w-full mt-4 text-sm tracking-wider transition-all duration-500 transform hover:scale-105 hover:-translate-y-1 ${
                    scrolled
                      ? "border-black text-black hover:bg-black hover:text-white shadow-lg hover:shadow-xl"
                      : "border-white text-white hover:bg-white hover:text-black shadow-lg hover:shadow-xl"
                  }`}
                  style={{
                    fontWeight: 400,
                    letterSpacing: "0.1em",
                    ...
                    boxShadow: scrolled 
                      ...
                      : "0 4px 8px rgba(255,255,255,0.2), 0 2px 4px rgba(255,255,255,0.1)"
                  }}
                >
                  HABLEMOS DE TU PROYECTO
                </Button>
