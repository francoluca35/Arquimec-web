                ...
                >
                  <div className="bg-gradient-to-br from-[#1a1f20] to-[#0f1516] border border-[#3e4b51] rounded-xl p-6 h-full hover:border-[#4a5568] transition-all duration-300 group-hover:scale-105">
                    ...
                    <button
                      ...
                      className="w-full text-center underline text-xs text-gray-300 hover:text-white border border-gray-600 hover:border-gray-400 rounded-lg py-2 px-4 transition-all duration-300 group-hover:bg-gray-800"
                    >
                      Leer más
                    </button>
                  </div>
