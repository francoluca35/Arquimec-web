      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="relative">
            <div className="w-[15rem] h-screen bg-gray-200 rounded-lg overflow-hidden shadow-xl">
              <ImageWithFallback
                ...
                className="w-full h-full object-cover filter brightness-110 contrast-110 saturate-125"
                fill={true}
                sizes="384px"
