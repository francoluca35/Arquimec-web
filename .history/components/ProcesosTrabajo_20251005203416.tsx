      ...
      >
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-10">
          <div className="text-center lg:text-left">
            <h2
              className="text-3xl lg:text-4xl text-gray-100 mb-2 leading-tight font-architectural-title"
          ...
          <div className="text-center lg:text-right">
            <p
              className="text-gray-100 text-xs tracking-wider font-architectural-subtitle"
                ...
                <div className="absolute inset-0 w-full h-full backface-hidden rotateY-180">
                  ...
                  <div className="absolute inset-0 z-20 flex flex-col justify-between p-8">
                    ...
                    <div className="flex flex-col items-center justify-center flex-1">
                      ...
                      <div className=" rounded-lg px-4 py-2 mb-3 ">
                        <h3 className="text-white text-lg lg:text-xl font-bold text-center leading-tight">
                          {proceso.titulo}
                        </h3>
                      </div>
                      <div className=" rounded-lg px-4 py-3 ">
                        <p className="text-white text-sm leading-relaxed text-center max-w-xs font-medium">
                          {proceso.descripcion}
                        </p>
                      </div>
                    </div>
