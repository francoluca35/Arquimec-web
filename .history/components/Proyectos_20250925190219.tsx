...
const Proyectos: React.FC = () => {
  ...
  const proyectos = [
    ...
    },
    {
      ...
      gridClass: "col-span-1 row-span-1 col-start-3 row-start-3"
    },
    {
      id: 7,
      ...
      gridClass: "col-span-1 row-span-1 col-start-4 row-start-3"
    }
  ];
  ...
  return (
    <section id="proyectos" className="py-32 bg-gray-50">
      <div className="w-full px-4">
        ...
        {/* Collage Grid */}
        <div className="grid grid-cols-4 grid-rows-4 h-[800px]">
          {proyectos.map((proyecto, index) => (
            <motion.div
              key={proyecto.id}
              className={`relative overflow-hidden cursor-pointer group ${proyecto.gridClass}`}
