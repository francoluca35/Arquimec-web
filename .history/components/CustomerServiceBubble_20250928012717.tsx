...
const CustomerServiceBubble: React.FC<CustomerServiceBubbleProps> = ({ 
  ...
  const generateAIResponse = (userMessage: string, context: typeof conversationContext) => {
    ...
    const keywords = {
      arquitectura: ['arquitecto', 'diseño', 'casa', 'edificio', 'construcción', 'proyecto', 'plano'],
      servicios: ['servicio', 'contratar', 'precio', 'costo', 'tarifa', 'presupuesto'],
      tecnico: ['técnico', 'estructura', 'ingeniería', 'cálculo', 'material', 'especificación'],
      contacto: ['contacto', 'teléfono', 'email', 'dirección', 'ubicación', 'oficina'],
