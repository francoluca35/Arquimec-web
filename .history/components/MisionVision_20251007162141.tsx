...
const MisionVision: React.FC = () => {
  return (
    <section id="mision-vision" className="py-20 bg-[#1a2a3c]">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="bg-gradient-to-br from-[#1a1f20] to-[#1a2a3c] border border-[#3e4b51] rounded-2xl p-8 h-full hover:border-[#4a5568] transition-all duration-300">
                {/* Icono */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div className="bg-gradient-to-br from-[#1a1f20] to-[#1a2a3c] border border-[#3e4b51] rounded-xl p-6 h-full hover:border-[#4a5568] transition-all duration-300 group-hover:scale-105">
