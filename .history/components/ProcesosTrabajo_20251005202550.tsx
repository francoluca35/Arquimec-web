              ...
              <div className="relative w-full h-full transition-transform duration-700 group-hover:rotateY-180" style={{ transformStyle: "preserve-3d" }}>
                ...
                <div className="absolute inset-0 w-full h-full backface-hidden rotateY-180">
                  ...
                  <div className="absolute inset-0 z-20 flex flex-col justify-between p-8">
                    {/* Número */}
                    <div className="text-6xl lg:text-7xl font-light text-white/40">
                      {proceso.numero}
                    </div>

                    {/* Descripción centrada */}
                    <div className="flex flex-col items-center justify-center flex-1">
                      <div className="mb-6 p-3 rounded-full  backdrop-blur-sm border border-white/20">
                        <proceso.icono className="w-6 h-6 text-white" strokeWidth={1.5} />
                      </div>
                      <div className=" rounded-lg px-4 py-2 mb-3 backdrop-blur-sm">
                        <h3 className="text-white text-lg lg:text-xl font-bold text-center leading-tight">
                          {proceso.titulo}
                        </h3>
                      </div>
                      <div className=" rounded-lg px-4 py-3 backdrop-blur-sm">
                  ...
                  {/* Borde sutil */}
                  <div className="absolute inset-0 rounded-2xl border border-white/10 z-30"></div>
                </div>
              </div>
            </motion.div>
          ))}
