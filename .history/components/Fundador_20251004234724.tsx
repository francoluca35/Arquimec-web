...
const Fundador: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="py-32" style={{ backgroundColor: currentPalette.colors.light }}>
        ...
        >
          <div className="mb-8">
            <h2
              ...
              style={{ fontWeight: 300, color: currentPalette.colors.primary }}
            >
              Desde 2010, entregando calidad
            </h2>
            <p className="text-lg leading-relaxed mb-8" style={{ color: currentPalette.colors.secondary }}>
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <span style={{ color: currentPalette.colors.accent }}>+</span>
              </div>
              <p
                className="text-sm tracking-wider"
                style={{ letterSpacing: "0.15em", color: currentPalette.colors.neutral }}
              >
                M² CONSTRUIDOS
              </p>
            </div>
