...
const NavbarButton = React.forwardRef<HTMLButtonElement, NavbarButtonProps>(
  ({ className, scrolled = false, ...props }, ref) => {
    return (
      <button
        className={cn(
          "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-500 transform hover:scale-100 disabled:pointer-events-none disabled:opacity-50 outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
