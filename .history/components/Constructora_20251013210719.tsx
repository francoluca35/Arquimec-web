      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
                <Button
                 className="contact-button-border bg-[#1a2a3c00] text-white hover:bg-[#2a3a4c00] hover:border-[#e5a648] px-8 py-3 text-sm tracking-wider transition-all duration-300"
                  style={{
                    fontWeight: 400,
                    letterSpacing: "0.1em",
                  }}
