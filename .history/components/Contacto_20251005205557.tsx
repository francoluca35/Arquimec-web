    ...
    <section id="contacto" className="py-20" style={{ backgroundColor: '#003049' }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            {/* Mapa */}
            <div className="h-[300px] w-full rounded-2xl overflow-hidden shadow-2xl border border-white/10">
              <iframe
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              <h3 className="text-xl font-architectural-title font-semibold text-white mb-6">
                Información de Contacto
              </h3>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-[#AE1F23]/20 rounded-lg flex items-center justify-center">
                    <MapPin className="w-6 h-6 text-[#AE1F23]" />
                  </div>
                  <div>
                    <p className="font-semibold text-white mb-1">Dirección</p>
                    <p className="text-white/70">Av. Corrientes 1234, Buenos Aires, Argentina</p>
                  </div>
                </div>
                
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-[#AE1F23]/20 rounded-lg flex items-center justify-center">
                    <Phone className="w-6 h-6 text-[#AE1F23]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-[#AE1F23]/20 rounded-lg flex items-center justify-center">
                    <Mail className="w-6 h-6 text-[#AE1F23]" />
                  </div>
                  <div>
                    <p className="font-semibold text-white mb-1">Email</p>
                    <p className="text-white/70">contacto@arquimec.com</p>
                  </div>
                </div>
              </div>
            </div>
