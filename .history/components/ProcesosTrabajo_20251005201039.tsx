            ...
            >
              ...
              <div className="relative w-full h-full transition-transform duration-700 group-hover:rotateY-180" style={{ transformStyle: "preserve-3d" }}>
                ...
                <div className="absolute inset-0 w-full h-full backface-hidden rotateY-180">
                  ...
                  <div className="relative z-10 h-full flex flex-col justify-between p-8">
                    {/* Número */}
                    <div className="text-6xl lg:text-7xl font-light text-black/20">
                      {proceso.numero}
                    </div>

                    {/* Descripción centrada */}
                    <div className="flex flex-col items-center justify-center flex-1">
                      <div className="mb-6 p-4 rounded-full bg-black/10">
                        <proceso.icono className="w-8 h-8 text-black" strokeWidth={1.5} />
                      </div>
                      <h3 className="text-black text-lg lg:text-xl font-medium text-center leading-tight mb-4">
                        {proceso.titulo}
                      </h3>
                      <p className="text-black/80 text-sm leading-relaxed text-center max-w-xs">
                        {proceso.descripcion}
                      </p>
                    </div>
                  </div>
                  ...
                  {/* Borde sutil */}
                  <div className="absolute inset-0 rounded-2xl border border-black/10"></div>
                </div>
              </div>
            </motion.div>
          ))}
