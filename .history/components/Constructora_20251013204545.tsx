...
const Constructora: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="constructora"
      className="py-32 bg-[#0F1516] relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="mb-12">
              <div className="text-3xl lg:text-4xl text-gray-900 mb-8 leading-tight">
                <motion.div
                  style={{ 
                    fontWeight: 300,
                    opacity: line1Opacity
              ...
              {servicios.map((servicio, index) => (
                ...
                >
                  <div className="flex items-start space-x-3">
                    <div className="w-10 h-10 bg-[#1a2a3c] rounded-lg flex items-center justify-center flex-shrink-0">
