      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="relative">
            <div className="w-96 h-[28rem] bg-gray-200 rounded-2xl overflow-hidden shadow-xl">
              <ImageWithFallback
                ...
                className="w-full h-full object-cover filter sepia-20 brightness-90 contrast-110 saturate-90"
                fill={true}
                sizes="384px"
                priority={true}
              />
