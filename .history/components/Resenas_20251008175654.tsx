    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl lg:text-5xl font-light tracking-wider text-gray-900 mb-4">
            LO QUE DICEN NUESTROS CLIENTES
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            La satisfacción de nuestros clientes es la base de nuestro compromiso con la excelencia arquitectónica
          </p>
        </motion.div>
                ...
                <div key={reseña.id} className="w-full flex-shrink-0 px-4">
                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-gray-600 mb-2">{reseña.ubicacion}</p>
                      <p className="text-sm text-gray-500 mb-3">{reseña.proyecto}</p>
        ...
        >
          <div>
            <div className="text-4xl font-light text-gray-900 mb-2">5.0</div>
