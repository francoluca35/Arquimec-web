...
const Contacto: React.FC = () => {
  ...
  return (
    <section id="contacto" className="py-20" style={{ backgroundColor: currentPalette.colors.light }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6" style={{ color: currentPalette.colors.primary }}>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* NOMBRE */}
              <div>
                <label htmlFor="nombre" className="block text-sm font-semibold mb-3 uppercase tracking-wider" style={{ color: currentPalette.colors.primary }}>
                  NOMBRE
                </label>
                <input
                  type="text"
                  ...
                  required
                  className="w-full px-4 py-4 border rounded-lg text-lg"
                  style={{
                    borderColor: currentPalette.colors.neutral,
                    color: currentPalette.colors.primary,
                    backgroundColor: currentPalette.colors.light
                  }}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-400 focus:border-amber-400 text-lg"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-400 focus:border-amber-400 text-lg resize-none"
              ...
              <Button
                ...
                style={{
                  ...
                  ':hover': { backgroundColor: currentPalette.colors.secondary }
                }}
              >
                ENVIAR
              </Button>
          ...
          >
            ...
            <div className="mt-6 p-6 rounded-lg" style={{ backgroundColor: currentPalette.colors.light }}>
