        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative h-[500px] lg:h-[600px] overflow-hidden rounded-lg">
              <ImageWithFallback
                src="https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760413417/constructora/nestudio.jpg"
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                  <Button
                   className="bg-transparent text-white px-8 py-3 text-sm tracking-wider transition-all duration-300 border-2 focus:outline-none focus:ring-0"
                    style={{
                      fontWeight: 400,
                      letterSpacing: "0.1em",
                      borderColor: '#3e4b51',
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.borderColor = '#e5a648';
                      e.currentTarget.style.color = '#e5a648';
                      e.currentTarget.style.backgroundColor = 'transparent';
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.borderColor = '#3e4b51';
              ...
              >
                  <Button
                   className="bg-[#e5a648] text-black hover:bg-[#d4941e] px-8 py-3 text-sm tracking-wider transition-all duration-300 border-0 focus:outline-none focus:ring-0"
                    style={{
                      fontWeight: 400,
                      letterSpacing: "0.1em",
                      outline: 'none',
                    ...
                    onClick={() => router.push('/constructora')}
                  >
                  Saber más +
                </Button>
              </motion.div>
