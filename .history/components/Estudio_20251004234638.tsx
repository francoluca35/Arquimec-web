        ...
        >
          <div className="mb-8">
            <motion.p
              ...
              style={{ 
                color: currentPalette.colors.neutral,
          ...
          <div className="mb-12">
            <div className="text-4xl lg:text-5xl mb-8 leading-tight" style={{ color: currentPalette.colors.light }}>
              <motion.div
                style={{ 
                  fontWeight: 300,
                  opacity: line1Opacity
          ...
          >
            <Button
              className="contact-button-border bg-transparent px-8 py-3 text-sm tracking-wider transition-all duration-300 hover:bg-transparent"
              style={{
                fontWeight: 400,
                letterSpacing: "0.1em",
                color: currentPalette.colors.light,
                borderColor: currentPalette.colors.accent,
                ':hover': { color: currentPalette.colors.accent }
              }}
