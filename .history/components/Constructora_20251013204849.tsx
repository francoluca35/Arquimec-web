        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="mb-8">
              ...
              >
                CONSTRUCCIÓN PROFESIONAL EN BUENOS AIRES
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              {servicios.map((servicio, index) => (
                <motion.div
                  key={index}
                  className="bg-[#383c40] p-4 rounded-lg"
                ...
                >
                  <div className="flex items-start space-x-3">
                    <div className="w-10 h-10 bg-[#d5d5d5] rounded-lg flex items-center justify-center flex-shrink-0">
                      <servicio.icono className="w-5 h-5 text-black" strokeWidth={1.5} />
                    </div>
                    <div>
                      <h4 className="font-medium text-white text-sm mb-1">
                        {servicio.titulo}
                      </h4>
                      <p className="text-xs text-gray-6¿200 leading-relaxed">
            ...
            >
              <Button
                className="contact-button-border bg-[#1a2a3c] text-white hover:bg-[#2a3a4c] px-8 py-3 text-sm tracking-wider transition-all duration-300"
                style={{
                  fontWeight: 400,
                  letterSpacing: "0.1em",
                }}
