  ...
  return (
    <section className="relative h-[90vh] overflow-hidden">
      ...
      <div className="absolute bottom-8 right-8 z-20 text-right">
        <p className="text-white/80 text-sm tracking-wider mb-2" style={{textShadow: '2px 2px 4px rgba(251,191,36,0.8)'}}>
          {proyectoDestacado.categoria}
        </p>
        <p className="text-white text-lg font-medium mb-4" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>
