...
const Fundador: React.FC = () => {
  ...
  // Array de todas las imágenes que quieres mostrar
  const images = [
    { src: "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760413987/fundadores/fundadorlogo.png", alt: "Logo Arquimec" },
    { src: "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760413981/fundadores/equipo2.jpg", alt: "Equipo Arquimec 2" },
    { src: "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760413982/fundadores/equipo.jpg", alt: "Equipo Arquimec" },
    { src: "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760413984/fundadores/fundador2.jpg", alt: "Fundador 2" },
    { src: "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760413986/fundadores/fundadores.jpg", alt: "Fundadores" },
  ...
  // Efecto para rotar entre todas las imágenes
  useEffect(() => {
  ...
  return (
    <section ref={sectionRef} id="nosotros" className="py-32 bg-white ">
    <div className="max-w-7xl mx-auto px-6 lg:px-8 mb-20 -mt-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
            ...
            <div className={`rounded-lg overflow-hidden relative bg-transparent ${
              images[currentImageIndex].src.includes('fundadorlogo.png') 
                ? 'w-80 sm:w-96 h-[20rem] sm:h-[24rem]' 
                : 'w-80 sm:w-96 h-[24rem] sm:h-[28rem]'
            }`}>
              <motion.div
