...
const Fundador: React.FC = () => {
  ...
  const images = [
    { src: "/Assets/equipo2.JPG", alt: "Equipo Arquimec 2" },
    { src: "/Assets/equipo.JPG", alt: "Equipo Arquimec" },
    { src: "/Assets/fundador2.jpg", alt: "Fundador 2" },
    { src: "/Assets/fundadores.webp", alt: "Fundadores" },
    { src: "/Assets/Fundadorlogo.png", alt: "Logo Arquimec" }
  ];
