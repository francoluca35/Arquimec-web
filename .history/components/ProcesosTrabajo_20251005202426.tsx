              ...
              <div className="relative w-full h-full transition-transform duration-700 group-hover:rotateY-180" style={{ transformStyle: "preserve-3d" }}>
                ...
                <div className="absolute inset-0 w-full h-full backface-hidden rotateY-180">
                  ...
                  <div className="relative z-10 h-full flex flex-col justify-between p-8">
                    ...
                    <div className="flex flex-col items-center justify-center flex-1">
                      <div className="mb-6 p-3 rounded-full bg-white/20 backdrop-blur-sm">
                        <proceso.icono className="w-6 h-6 text-white" strokeWidth={1.5} />
                      </div>
                      <h3 className="text-white text-lg lg:text-xl font-semibold text-center leading-tight mb-3 drop-shadow-lg">
                        {proceso.titulo}
                      </h3>
                      <p className="text-white text-sm leading-relaxed text-center max-w-xs drop-shadow-md">
                        {proceso.descripcion}
                      </p>
                    </div>
                  </div>
