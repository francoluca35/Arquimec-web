          ...
          {procesos.map((proceso, index) => (
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col justify-between p-8">
                {/* Número */}
                <div className="text-6xl lg:text-7xl font-light text-white/20 group-hover:text-white/30 transition-colors duration-300">
                  {proceso.numero}
                </div>

                {/* Icono y título */}
                <div className="flex flex-col items-center justify-center flex-1">
                  <div className="mb-4 p-4 rounded-full bg-white/10 backdrop-blur-sm group-hover:bg-white/20 transition-all duration-300">
