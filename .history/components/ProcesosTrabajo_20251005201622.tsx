              ...
              <div className="relative w-full h-full transition-transform duration-700 group-hover:rotateY-180" style={{ transformStyle: "preserve-3d" }}>
                ...
                <div className="absolute inset-0 w-full h-full backface-hidden rotateY-180">
                  ...
                  <div className="w-full h-full relative overflow-hidden">
                    ...
                    />
                     <div className="flex flex-col items-center justify-center flex-1">
                      <div className="mb-6 p-4 rounded-full bg-white/40 backdrop-blur-sm border border-white/30 shadow-lg">
                        <proceso.icono className="w-8 h-8 text-white" strokeWidth={2} />
                      </div>
                      <div className="bg-black/50 backdrop-blur-sm rounded-lg px-4 py-2 mb-4 shadow-xl">
                        <h3 className="text-white text-lg lg:text-xl font-bold text-center leading-tight">
                          {proceso.titulo}
                        </h3>
                      </div>
                      <div className="bg-black/60 backdrop-blur-sm rounded-lg px-4 py-3 shadow-xl">
                        <p className="text-white text-sm leading-relaxed text-center max-w-xs font-semibold">
                          {proceso.descripcion}
                        </p>
                      </div>
                    </div>
                    {/* Overlay muy oscuro para legibilidad del texto */}
                  ...
                  <div className="relative z-10 h-full flex flex-col justify-between p-8">
                    {/* Número */}
                    <div className="text-6xl lg:text-7xl font-light text-white/50">
                      {proceso.numero}
                    </div>
