  ...
  return (
    <>
      ...
      <motion.header
        ...
        style={{
          backgroundColor: scrolled ? currentPalette.colors.light : currentPalette.colors.primary
        }}
                ...
                item.href.startsWith('/') ? (
                  <motion.button
                    ...
                    style={{
                      fontWeight: 400,
                      letterSpacing: "0.1em",
                      color: scrolled ? currentPalette.colors.primary : currentPalette.colors.light,
                    }}
          ...
          >
            <div className="relative flex flex-col space-y-6 p-8 pt-8 h-full">
              ...
              <div className="w-full mt-4 space-y-3">
                <ColorPaletteSelector className="w-full" />
                <NavbarButton
                  scrolled={scrolled}
