      ...
      <div className="w-full">
        ...
        >
          <button
            ...
            className="bg-gray-900 text-white px-8 py-4 text-sm tracking-wider hover:bg-gray-800 transition-all duration-500 ease-in-out hover:shadow-lg hover:shadow-gray-400/50"
            style={{ fontWeight: 300 }}
          >
            TODOS LOS PROYECTOS
          </button>
