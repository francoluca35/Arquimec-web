...
// Iconos personalizados arquitectónicos
const IconoResidencial = () => (
  <svg viewBox="0 0 48 48" className="w-8 h-8" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24 6L6 18V42H18V28H30V42H42V18L24 6Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M30 42V28H18V42" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M6 18L24 6L42 18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <rect x="20" y="14" width="8" height="6" stroke="currentColor" strokeWidth="2"/>
  </svg>
);

const IconoComercial = () => (
  <svg viewBox="0 0 48 48" className="w-8 h-8" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="6" y="12" width="36" height="30" stroke="currentColor" strokeWidth="2"/>
    <path d="M6 12L24 4L42 12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <rect x="12" y="18" width="6" height="6" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="21" y="18" width="6" height="6" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="30" y="18" width="6" height="6" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="12" y="28" width="6" height="6" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="21" y="28" width="6" height="6" stroke="currentColor" strokeWidth="1.5"/>
    <rect x="30" y="28" width="6" height="6" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);

const IconoInteriores = () => (
  <svg viewBox="0 0 48 48" className="w-8 h-8" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="6" y="6" width="36" height="36" stroke="currentColor" strokeWidth="2"/>
    <path d="M6 24H42M24 6V42" stroke="currentColor" strokeWidth="2"/>
    <circle cx="15" cy="15" r="3" stroke="currentColor" strokeWidth="1.5"/>
    <circle cx="33" cy="15" r="3" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M12 33H20V39H12V33Z" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M28 30L36 36M28 36L36 30" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);

const IconoConsultorias = () => (
  <svg viewBox="0 0 48 48" className="w-8 h-8" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M24 20V24L26 26" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
...
const Servicios: React.FC = () => {
  ...
  const servicios = [
    ...
    },
    {
      ...
      imagen: "https://res.cloudinary.com/dmfy5ohhf/image/upload/v1760414269/protrabajos/1.jpg",
